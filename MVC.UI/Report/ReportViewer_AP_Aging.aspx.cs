...
{
    public partial class ReportViewer_AP_Aging : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           string logo = Request.QueryString["logo"].ToString();
            ...
            if (!Page.IsPostBack)
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report/Rpt_AP_Aging.rdlc");
                ...
                if (ds.Tables[0].Rows.Count > 0) {
                    ReportDataSource rdc = new ReportDataSource("DS_APAGING", ds.Tables[0]);
                    //ReportViewer1.LocalReport.SetParameters(parameters);
        ...
        private DataSet GetData()
        {
            ...
            cmd.Connection = con;
            cmd = new SqlCommand("[sp_report_AP_Aging]", cmd.Connection);
